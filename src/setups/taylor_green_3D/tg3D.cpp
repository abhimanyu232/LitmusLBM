...
struct RunConfig {
	...
	std::array<index_type, Dim> domain_size = {64, 64, 64};
	...
	bool save_file = true;
	index_type save_interval = 100;

	std::string case_name = "tg_3D";
	std::string output_directory = "tg3D_results";
...
class SimTraits {
 public:
	...
	using setup_t = TaylorGreenVortex_3D<model_t, config_t, writer_t>;	// bc_t
};
